...
public class ListaSemanaTransporteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_semana_transporte);
        iniciarComponentes();
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(ListaSemanaTransporteActivity.this, LancarPreventivosActivity.class);
    ...
    public void iniciarComponentes(){
        recyclerViewPreventivos = findViewById(R.id.recyclerViewListaPreventivosSemanaisTransporte);
    }
