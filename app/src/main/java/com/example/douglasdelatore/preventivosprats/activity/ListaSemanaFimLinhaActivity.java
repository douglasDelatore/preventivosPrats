...
public class ListaSemanaFimLinhaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_semana_fim_linha);
        iniciarComponentes();
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(ListaSemanaFimLinhaActivity.this, LancarPreventivosActivity.class);
    ...
    public void iniciarComponentes(){
        recyclerViewPreventivos = findViewById(R.id.recyclerViewListaPreventivosSemanaisFimLinha);
    }
