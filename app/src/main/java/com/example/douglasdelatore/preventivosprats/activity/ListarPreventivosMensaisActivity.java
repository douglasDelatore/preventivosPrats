...
public class ListarPreventivosMensaisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_preventivos_mensais);
        iniciarComponentes();

        preventivosRef = ConfiguracaoFirebase.getFirebase().child("PreventivoFixo")
                .child("Sidel").child("Enchedora").child("Mensal");
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(ListarPreventivosMensaisActivity.this, LancarPreventivosActivity.class);
    ...
    public void iniciarComponentes(){
        recyclerViewPreventivos = findViewById(R.id.recyclerViewListaPreventivosMensais);
    }
