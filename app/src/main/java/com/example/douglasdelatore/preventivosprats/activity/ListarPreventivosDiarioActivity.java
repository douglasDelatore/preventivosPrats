...
public class ListarPreventivosDiarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_preventivos_diario);
        iniciarComponentes();

        preventivosRef = ConfiguracaoFirebase.getFirebase().child("PreventivoFixo")
                .child("Sidel").child("Enchedora").child("Diario");
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(ListarPreventivosDiarioActivity.this, LancarPreventivosActivity.class);
    ...
    public void iniciarComponentes(){
        recyclerViewPreventivos = findViewById(R.id.recyclerViewListaPreventivosDiarios);
    }
