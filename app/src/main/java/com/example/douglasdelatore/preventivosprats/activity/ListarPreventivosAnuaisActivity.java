...
public class ListarPreventivosAnuaisActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listar_preventivos_anuais);
        iniciarComponentes();
                ...
                new RecyclerItemClickListener(
                        ...
                        new RecyclerItemClickListener.OnItemClickListener() {
                            ...
                            public void onItemClick(View view, int position) {
                                ...
                                Intent intent = new Intent(ListarPreventivosAnuaisActivity.this, LancarPreventivosActivity.class);
    ...
    public void iniciarComponentes(){
        recyclerViewPreventivos = findViewById(R.id.recyclerViewListaPreventivosAnuais);
    }
